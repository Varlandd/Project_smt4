...
<style>
    ...
    .dark-mode .form-card .form-header {
        border-bottom-color: #334155;
    }
    .dark-mode .form-card .form-header h3 {
        color: #f1f5f9;
    }
    ...
    <form action="{{ route('admin.rumah.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-grid-2">
            <div>
                ...
                <input type="text" id="nama" name="nama" value="{{ old('nama') }}" placeholder="Contoh: Rumah Minimalis Bogor" required>
            </div>
            <div>
        ...
        {{-- Row 2: Lokasi (Dropdown Jabodetabek) --}}
        ...
        <div class="form-group">
            ...
            <input type="number" id="harga" name="harga" value="{{ old('harga') }}" placeholder="Contoh: 500000000" required min="0">
        ...
        <div class="form-grid-4">
            <div>
                ...
                <input type="number" id="luas_tanah" name="luas_tanah" value="{{ old('luas_tanah') }}" placeholder="72" required min="0">
            </div>
            <div>
                <label for="luas_bangunan">L. Bangunan (m²) *</label>
                <input type="number" id="luas_bangunan" name="luas_bangunan" value="{{ old('luas_bangunan') }}" placeholder="45" required min="0">
            </div>
            <div>
                <label for="kamar_tidur">K. Tidur *</label>
                <input type="number" id="kamar_tidur" name="kamar_tidur" value="{{ old('kamar_tidur') }}" placeholder="3" required min="0">
            </div>
            <div>
                <label for="kamar_mandi">K. Mandi *</label>
                <input type="number" id="kamar_mandi" name="kamar_mandi" value="{{ old('kamar_mandi') }}" placeholder="2" required min="0">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi" name="deskripsi" rows="4" placeholder="Deskripsi singkat tentang properti...">{{ old('deskripsi') }}</textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-hint">Format: JPEG, PNG, GIF. Maks 2MB</div>
        </div>

        {{-- Submit --}}
        <div style="padding-top: 10px;">
            <button type="submit" class="btn-save">💾 Simpan Properti</button>
        </div>
    </form>
</div>
@endsection
